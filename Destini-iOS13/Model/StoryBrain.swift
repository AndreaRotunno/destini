...
struct StoryBrain {
    ...
    func nextStory(userChoice: String){
        if userChoice == storyBrain.story[currentDestination].choice1 {
         currentDestination = storyBrain.story[currentDestination].choice1Destination
        } else {
            currentDestination = storyBrain.story[currentDestination].choice2Destination
        }
    }
}
